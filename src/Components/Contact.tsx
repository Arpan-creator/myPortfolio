...
import toast from "react-hot-toast";
 ...
 const Contact = () => {
    ...
    return <div className="px-16 md-mx:px-8 sm-mx:px-4 mx-20 lg-mx:mx-10 md-mx:mx-0   my-10  font-mono" id="Contact">
        <h1 className="text-4xl  sm-mx:text-3xl xs-mx:text-2xl mb-10 font-bold text-center text-white"><span className="text-primaryColor">&nbsp;</span>Contact</h1>
       {/* <p className="text-center text-white text-xl mb-5">Bangalore, Karnataka, India</p> */}
        <div data-aos="flip-left" data-aos-duration="800" className="w-[70%] lg-mx:w-full shadow-[0_0_10px_0_#64FFDA50] m-auto flex flex-col gap-6 border border-primaryColor p-8 rounded-3xl sm-mx:p-4">
            <h2 className="text-2xl font-bold text-center text-white mb-5 flex flex-wrap justify-center gap-3">
         <a href="tel:+919932176726" className="hover:text-blue-400">📞 +91 9932176726</a><span className="text-gray-400">|</span><a href="mailto:arpan.9932176726@gmail.com" className="hover:text-blue-400">✉️ arpan.9932176726@gmail.com</a><span className="text-gray-400">|</span><a href="mailto://www.arpan.01@gmail.com" target="_blank" rel="noopener noreferrer"className="hover:text-blue-400">✉️ www.arpan.01@gmail.com</a>
       </h2>
